...
urlpatterns = [
    ...
    path('software/<int:pk>/update/', views.software_update, name='software_update'),
    ...
    path('asset-category-fields/', views.asset_category_fields, name='asset_category_fields'),
    path('<int:pk>/gps-tracking-card/', views.asset_gps_tracking_card, name='asset_gps_tracking_card'),
    path('<int:pk>/gps-map-panel/', views.asset_gps_map_panel, name='asset_gps_map_panel'),
